...
export default function AdminAgentReport() {
  ...
  const filteredOrders = useMemo(() => {
    ...
    if (marketFilter !== "All") {
      result = result.filter(
        (order) => order.items[0].marketName.id ===marketFilter
      );
    }
    ...
    return result;
  }, [ordersData, deliveryStatus, dateRange,marketFilter]);
  ...
  const totals = useMemo(() => {
    return filteredOrders.reduce(
      (acc, order) => {
        ...
        acc.totalServices +=Number(order.serviceCost) || 0;
        return acc;
      },
      {
        totalTransactions: 0,
    ...
    <div className="container mx-auto px-4 py-20 sm:py-24">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-5 gap-4 mb-8">
        ...
        <div className="p-4 border rounded shadow text-center">
         ...
         <div className="p-4 border rounded shadow text-center">
          <h3 className="font-bold">Service Fees</h3>
          <p>{totals.totalServices}</p>
        </div>
        <div className="p-4 border rounded shadow text-center">
                ...
                <TableRow key={order.id}>
                  <TableCell>{i + 1}</TableCell>
                   ...
                   <TableCell>
                      ...
                      {order.items[0].marketName.marketName}
